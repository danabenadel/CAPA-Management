...
import { generateMockData } from './controllers/mock.controller.js';

import session from 'express-session';
import { initKeycloak } from './config/keycloak.js';
import fs from 'fs';

// Temporary logo copy wrapper
try {
  const src = '/home/danabenadel/PART_TIME/genericlab-capa/logo_generic_lab_copie_page-0001-removebg-preview.png';
  ...
  fs.copyFileSync(src, destDir + '/logo-genericlab.png');
} catch (e) { }
...
// Temporary Mock seeder
app.get('/api/seed-mock', generateMockData);
